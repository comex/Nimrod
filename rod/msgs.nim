...
type 
  TMsgKind* = enum 
    ...
    errXhasSideEffects, errIteratorExpected, errConstExpectsPtrOrRef, errUser,
    warnCannotOpenFile, 
...
const 
  MsgKindToStr*: array[TMsgKind, string] = ["unknown error", 
    ...
    "iterator within for loop context expected", "\'const\' in a type must be followed by \'ptr\' or \'ref\'", "$1", 
